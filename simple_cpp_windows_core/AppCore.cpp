...
std::wstring processMatrixInt(const std::wstring& input) {
    return processMatrix<int>(input);
}
...
std::wstring processArrayInt(const std::wstring& input) {
    return processArray<int>(input);
}